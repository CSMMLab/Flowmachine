...
# plot
p1 = scatter(gmv[:, 1], gmv[:, 2], marker = (:circle, 3, 0.6, D["mizu"], stroke(1, 0.1, :gray27, :dot)), legend=:none, xlims=(-1, 1), ylims=(0, 1), xlabel="U", ylabel="T")
...
p3 = scatter(∇gmv[:, 1], ∇gmv[:, 2], marker = (:circle, 3, 0.6, D["mizu"], stroke(1, 0.1, :gray27, :dot)), legend=:none, xlims=(-10, 10), ylims=(-10, 10), xlabel="∇U", ylabel="∇T")
